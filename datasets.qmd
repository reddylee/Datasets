...
write_csv(survival_data, "survival_cox_ph.csv")
```
...
mutate(first_year = startdate,
  ...
  drop_na() |> 
  select(id, ccode, country, leader, age, tstart, tstop, group, survival_days, status, GDP_trend, GDP_pc, pop_log, polity5, violence)
